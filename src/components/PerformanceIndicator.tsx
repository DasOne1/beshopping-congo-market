...
const PerformanceIndicator = memo(() => {
  ...
  return (
    <div className="fixed top-14 left-0 right-0 z-[60] flex justify-center">
      {/* Main indicator */}
      <div
      ...
      >
        <Badge
          variant="secondary"
          className={cn(
            "rounded-t-none rounded-b-lg transition-colors duration-200 shadow-sm",
        ...
        {showDetails && (
          <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 bg-background/95 backdrop-blur border rounded-lg p-3 space-y-2 shadow-lg min-w-[200px]">
