  ...
  return (
    <div className="container py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        />
        <Select onValueChange={(value) => handleFilterChange({ target: { name: 'category', value } } as any)}>
        ...
        <Select onValueChange={(value) => handleFilterChange({ target: { name: 'status', value } } as any)}>
          <SelectTrigger className="w-full">
        ...
        <Select onValueChange={(value) => handleFilterChange({ target: { name: 'price', value } } as any)}>
          <SelectTrigger className="w-full">
